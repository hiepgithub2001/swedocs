...
> **paradigm** you think in, then the three deep design choices (**types, memory, concurrency**),
> then how you build on top with **frameworks**.
...
## Language design — the three deep choices
